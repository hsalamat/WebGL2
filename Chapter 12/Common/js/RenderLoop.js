...
class RenderLoop{
	constructor(callback,fps){
		...
		if(fps > 0){ //Build a run method that limits the framerate
			...
			this.run = function(){
				//Calculate Deltatime between frames and the FPS currently.
				var msCurrent	= performance.now(),	//Gives you the whole number of how many milliseconds since the begining
					deltaTime	= (msCurrent - oThis.msLastFrame) / 1000.0;	//ms between frames, by 1 second to get the fraction of a second.
